...
from website.addons.ojs.utils import serialize_settings, settings_complete
...
def ojs_settings(node_addon, **kwargs):
    return serialize_settings(node_addon)


@must_have_permission('write')
@must_have_addon('ubiquitypress', 'node')
def ojs_settings_put(auth, node_addon, **kwargs):
    ...
    """
    try:
        node_addon.journal_url = request.json['journal_code']
...
@must_have_addon('ubiquitypress', 'node')
def ojs_widget(node_addon, **kwargs):
